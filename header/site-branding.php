        ...
        <div class="row border-header">
          <div class="call col-lg-3 col-md-3 align-self-md-center">
            <?php if( get_theme_mod('automobile_hub_call','') ) { ?>
              <p class="simplep mb-0"><a href="tel:<?php echo esc_html( get_theme_mod('automobile_hub_call','') ); ?>"><i class="<?php echo esc_attr(get_theme_mod('automobile_hub_call_icon','fas fa-phone')); ?> me-2"></i><?php echo esc_html( get_theme_mod('automobile_hub_call','') ); ?></a></p>
            <?php } ?>
          </div>
          <div class="email col-lg-4 col-md-4 align-self-md-center">
            <?php if( get_theme_mod( 'automobile_hub_mail' ) != '' ) { ?>
              <p class="simplep mb-0"><a href="mailto:<?php echo esc_html( get_theme_mod('automobile_hub_mail','') ); ?>"><i class="<?php echo esc_attr(get_theme_mod('automobile_hub_mail_icon','fas fa-envelope-open')); ?> me-2"></i><?php echo esc_html( get_theme_mod('automobile_hub_mail','') ); ?></a></p>
            <?php } ?>
          </div>
          <div class="address col-lg-5 col-md-5 align-self-md-center">
            <?php if( get_theme_mod( 'car_paint_job_location' ) != '' ) { ?>
              <p class="simplep mb-0"><i class="fas fa-map-marker-alt me-2"></i><?php echo esc_html( get_theme_mod('car_paint_job_location','') ); ?></p>
            <?php } ?>
          </div>
        </div>
